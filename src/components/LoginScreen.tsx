            ...
            <div className="relative z-10 w-full max-w-md">
                ...
                <div className="bg-white dark:bg-[#13141f] border border-gray-200 dark:border-white/5 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden">
                    ...
                    <button
                        ...
                        className="relative z-10 w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-800 text-gray-900 dark:text-white py-3 rounded-xl font-bold hover:bg-gray-100 dark:hover:bg-gray-700 transition-all active:scale-95"
                    >
