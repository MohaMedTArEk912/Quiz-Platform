...
const RegisterScreen: React.FC<RegisterScreenProps> = ({ onRegister, onSwitchToLogin }) => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0b] flex items-center justify-center p-6 relative overflow-hidden selection:bg-pink-500/30">
            {/* Ambient Background */}
            ...
            <div className="relative z-10 w-full max-w-md">
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 font-medium">Join the ranks and start your journey.</p>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                        <div>
                            ...
                            <div className="relative group">
                                <User className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-gray-500 group-focus-within:text-pink-500 dark:group-focus-within:text-pink-400 transition-colors w-5 h-5" />
                                <input
                                    type="text"
                                    value={name}
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                <Mail className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-gray-500 group-focus-within:text-pink-500 dark:group-focus-within:text-pink-400 transition-colors w-5 h-5" />
                                <input
                                    type="email"
                                    value={email}
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                <Lock className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-gray-500 group-focus-within:text-pink-500 dark:group-focus-within:text-pink-400 transition-colors w-5 h-5" />
                                <input
                    ...
                    <div className="mt-8 text-center relative z-10">
                        <p className="text-gray-600 dark:text-gray-400 font-medium">
                            ...
                            <button
                                ...
                                disabled={isLoading}
                                className="text-pink-600 dark:text-pink-400 font-bold hover:text-pink-500 dark:hover:text-pink-300 transition-colors uppercase tracking-wide hover:underline ml-1 disabled:opacity-50"
                            >
                                Sign In
                            </button>
                        </p>
