    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0b] text-gray-900 dark:text-white selection:bg-purple-500/30">
                ...
                <div className="w-full px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">Platform Management System</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className="p-2 text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5 rounded-xl transition-all"
                            title="Settings"
                        >
                        ...
                        <button
                            onClick={onLogout}
                            className="flex items-center gap-2 px-4 py-2 bg-red-500/10 text-red-500 dark:text-red-400 border border-red-500/20 rounded-xl hover:bg-red-500/20 transition-all font-bold text-sm"
                        >
            ...
            <div className="flex h-[calc(100vh-73px)]">
                {/* Sidebar Navigation */}
                <div className="w-64 bg-gray-50 dark:bg-[#13141f] border-r border-gray-200 dark:border-white/5 p-4 flex flex-col gap-6 overflow-y-auto [&::-webkit-scrollbar]:hidden" style={{ scrollbarWidth: 'none' }}>
                    {[
                        {
                            title: 'Management',
                            items: [
                        ...
                        <div key={idx}>
                            <h3 className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 px-4">{section.title}</h3>
                                ...
                                {section.items.map(tab => (
                                    <button
                                        ...
                                        className={`w-full flex items-center gap-4 px-6 py-4 rounded-xl font-bold text-base transition-all text-left relative overflow-hidden group ${selectedTab === tab.id
                                            ...
                                            : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5 hover:pl-7'
                                            }`}
                                    >
                ...
                <div className="flex-1 overflow-y-auto p-8 relative [&::-webkit-scrollbar]:hidden" style={{ scrollbarWidth: 'none' }}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                        {[
                            ...
                            <div key={i} className="bg-white dark:bg-[#13141f] border border-gray-200 dark:border-white/5 rounded-[2rem] p-6 flex items-center gap-4 relative overflow-hidden group shadow-lg dark:shadow-none">
                                ...
                                <div className={`w-14 h-14 rounded-2xl bg-${stat.color}-500/20 flex items-center justify-center text-${stat.color}-600 dark:text-${stat.color}-400 group-hover:scale-110 transition-transform`}>
                                    <stat.icon className="w-7 h-7" />
                                </div>
                                <div>
                                    <div className="text-3xl font-black text-gray-900 dark:text-white mb-1 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-gray-900 dark:group-hover:from-white group-hover:to-gray-500 dark:group-hover:to-gray-400 transition-all">{stat.value}</div>
                    ...
                    {/* Content Area */}
                    <div className="bg-white dark:bg-[#13141f] border border-gray-200 dark:border-white/5 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden min-h-[500px]">
                                    ...
                                    {tournaments.map((t) => (
                                        <div key={t.tournamentId} className="bg-white dark:bg-[#13141f] border border-gray-200 dark:border-white/5 rounded-[2rem] p-6 group hover:border-yellow-500/30 transition-all shadow-sm">
                                            ...
                                            <div className="flex gap-2">
                                                ...
                                                <button onClick={() => setDeleteConfirmation({ isOpen: true, type: 'tournament', id: t.tournamentId })} className="p-2 bg-red-100 dark:bg-white/5 text-red-700 dark:text-red-400 rounded-xl hover:bg-red-200 dark:hover:bg-white/10">
