                            ...
                            {activeTab === 'overview' && (
                                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 grid grid-cols-1 lg:grid-cols-3 gap-8">
                                    <div className="lg:col-span-2 space-y-8">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div className="bg-white/40 dark:bg-white/5 backdrop-blur-xl rounded-[2.5rem] p-8 border border-white/20 dark:border-white/5">
                                                ...
                                                <div className="text-4xl font-black text-indigo-500 mb-4">{getSubjectProgress(selectedSubjectId!)}%</div>
                                                <div className="w-full h-2 bg-gray-100 dark:bg-white/5 rounded-full overflow-hidden">
                                                    <div className="h-full bg-indigo-500" style={{ width: `${getSubjectProgress(selectedSubjectId!)}%` }} />
                                                </div>
                                            </div>
                                            <div className="bg-white/40 dark:bg-white/5 backdrop-blur-xl rounded-[2.5rem] p-8 border border-white/20 dark:border-white/5">
                                    ...
                                    <div className="space-y-6">
                                        <div className="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-[2.5rem] p-8 text-white shadow-xl shadow-indigo-500/20">
                                            <Zap className="w-10 h-10 mb-4 bg-white/20 p-2 rounded-xl" />
                                            <h4 className="text-lg font-black mb-2 uppercase">Ready to start?</h4>
                                            <p className="text-white/80 text-sm font-medium mb-6">Take the next quiz in your journey to boost your rank and earn coins.</p>
                                            <button
                                                onClick={() => setActiveTab('quizzes')}
                                                className="w-full py-4 bg-white text-indigo-600 rounded-2xl font-black uppercase tracking-widest text-[10px] hover:scale-105 transition-transform"
                                            >
                                                Jump to Quizzes
                                            </button>
                                        </div>
                                    ...
                                    {filteredQuizzes.map((quiz) => {
                                        ...
                                        return (
                                            <div
                                                ...
                                                className="group relative min-h-[380px] cursor-pointer"
                                            >
                                                <div className={`absolute -inset-0.5 bg-gradient-to-br ${attempted ? 'from-emerald-500 to-teal-500' : 'from-indigo-500 to-purple-500'} rounded-[2.5rem] opacity-0 group-hover:opacity-20 blur-xl transition-all duration-500`} />

                                                <div className="relative h-full bg-white dark:bg-[#11111a] rounded-[2.5rem] border border-gray-200 dark:border-white/5 p-8 flex flex-col group-hover:-translate-y-2 transition-all duration-300">
                                                    ...
                                                    <div className="flex-grow">
                                                        ...
                                                        <p className="text-gray-500 dark:text-gray-400 text-xs font-medium leading-relaxed line-clamp-2 mb-6">
                                                            {quiz.description}
                                                        </p>
                                                    ...
                                                    <button className={`w-full py-4 rounded-2xl font-black uppercase tracking-widest text-[10px] transition-all flex items-center justify-center gap-2 ${attempted
