...
const QuizResults: React.FC<QuizResultsProps> = ({ result, onBackToQuizzes, onRetake }) => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 p-6 flex items-center justify-center">
                ...
                <div className="text-center">
                    ...
                    <div className="flex gap-4">
                        <button
                            ...
                            className="flex-1 flex items-center justify-center gap-2 bg-gray-100 text-gray-700 px-6 py-4 rounded-xl font-bold text-lg hover:bg-gray-200 transition-all"
                        >
